...
function EmployeeList() {
  ...
  const fetchDepartments = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/departments`, { headers: { 'Authorization': `Bearer ${token}` } });
  ...
  const fetchSkills = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/skills`, { headers: { 'Authorization': `Bearer ${token}` } });
  ...
  const openEditModal = async (empId) => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/employees/${empId}`, { headers: { 'Authorization': `Bearer ${token}` } });
      if (response.ok) {
  ...
  const handleModalSave = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/employees/${editData.id}`, {
        method: 'PUT',
